      ...
      sx={{
        ...
        <TimelineItem>
            ...
            <TimelineContent>
                ...
                <Typography variant='p'>- Created an open-source, full-stack, personal portfolio website template using Python, Flask, Jinja, MySQL, Nginx, Docker, and unittest, guaranteeing easy and flexible redeployment of code.</Typography>
