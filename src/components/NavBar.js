          ...
          <Navbar.Collapse id="basic-navbar-nav">
            ...
            <span className="navbar-text">
              <div className="social-icon">
                  ...
                  <a href="https://www.instagram.com/intentuskristen/" target="_blank"><span><GitHubIcon sx={{color: 'white'}}/></span></a>
                  <a href="https://www.instagram.com/intentuskristen/" target="_blank" ><span><ShareIcon sx={{color: 'white'}}/></span></a>
              </div>
